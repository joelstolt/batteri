          ...
          <div className="mx-auto max-w-[800px] px-4 py-10 sm:px-6">
            <div className="flex flex-col gap-8 text-base leading-relaxed text-text-mid">
              ...
              <div>
                ...
                <p>Personuppgiftsansvarig: Joel Stolt (enskild firma, org.nr 901108-0851) · E-post: <a className="text-navy underline" href="mailto:info@batteriproffs.se">info@batteriproffs.se</a> · Telefon: <a className="text-navy underline" href="tel:+46766867752">076-686 77 52</a></p>
              </div>
              <div>

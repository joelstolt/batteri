        ...
        <div className="mx-auto max-w-[800px] px-4 py-10 sm:px-6">
          <div className="flex flex-col gap-8 text-base leading-relaxed text-text-mid">
            <div>
              ...
              <p>Alla priser på batteriproffs.se anges i svenska kronor (SEK) exklusive moms om inget annat anges. Moms (25%) tillkommer. Betalning sker via kort (Visa/Mastercard) vid checkout. Din beställning är bindande när du genomfört betalningen och du får en orderbekräftelse via e-post.</p>
            </div>
            <div>
              <h2 className="mb-3 font-heading text-xl font-bold text-text-dark">Leverans</h2>
              <p>Vi skickar alla ordrar via PostNord. Beräknad leveranstid är 1–3 arbetsdagar. Order lagda före kl 14:00 på vardagar skickas normalt samma dag. Fast fraktkostnad på 149 kr exkl. moms per beställning i hela Sverige. Spårningsnummer skickas via e-post när din order har skickats.</p>
            </div>
            <div>

...
<style>
  ...
  @media (prefers-color-scheme: dark) {
    ...
    /*
     * Knappen är marinblå på vitt i ljust läge. I mörkt läge blev den
     * marinblå på marinblått kort och syntes knappt, uppmätt 2026-09-24.
     * Den byter därför till gul med mörk text, samma par som i loggan.
     */
    .bp-body a.bp-knapp { background: #FDB813 !important; color: #0A1628 !important; }
  ...
  [data-ogsc] .bp-knapp { color: #0A1628 !important; }
  [data-ogsb] .bp-knapp { background: #FDB813 !important; }
</style>
</head>

    ...
    items: [
      {
        ...
        a: `Vi har en fast fraktkostnad på ${STANDARD_SHIPPING_INCL_VAT} kr (inkl. moms) per beställning, oavsett vikt och destination i Sverige. Kontakta oss för offert vid större volymer eller pallgods.`,
      },
      {

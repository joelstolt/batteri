    ...
    items: [
      {
        ...
        a: "Vi säljer till företag, och vid köp i näringsverksamhet finns ingen ångerrätt. Vi tar ändå emot returer i 14 dagar. Mejla info@batteriproffs.se och invänta vårt godkännande innan du skickar tillbaka något, så får du returadress. Förpackningen ska vara obruten och batteriet får aldrig ha kopplats in eller laddats, inte ens för provkoppling. Vid godkänd retur av en felfri vara gör vi ett avdrag på 30 procent av varans värde, frakten återbetalas inte och du står för returfrakten.",
      },
      {
        q: "Vad gäller om batteriet inte passar min maskin?",
        a: "Då gäller passformsgarantin, utan returavdrag. Har vi rekommenderat batteriet via batterifinnaren, telefon eller mejl byter vi till rätt modell och står för frakten åt båda hållen. Har du beställt på egen hand byter vi ändå utan avdrag, men då står du för returfrakten. Förpackningen måste vara obruten och batteriet får inte ha kopplats in. Hör av dig inom 14 dagar och uppge maskinens märke och modell.",
      },
      {

 ...
 */
import { STANDARD_SHIPPING_INCL_VAT, RETURN_WINDOW_DAYS, RETURN_RESTOCKING_FEE_PERCENT, DELIVERY_ESTIMATE } from "./store-policy"
...
export const FAQ_SECTIONS = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Kassan på sajten är byggd för företag och kräver organisationsnummer, så en beställning går inte att slutföra som privatperson. Är du privatperson och vill köpa ett batteri, chatta med oss eller mejla info@batteriproffs.se så löser vi det manuellt.",
      },
      {
    ...
    items: [
      {
        ...
        a: `Fast frakt på ${STANDARD_SHIPPING_INCL_VAT} kr inklusive moms per beställning i hela Sverige, oavsett antal batterier, vikt eller om leveransen sker på pall. Inga frakttillägg tillkommer för tungt eller skrymmande gods. Totalpriset inklusive frakt visas i kassan innan du slutför köpet.`,
      },
      {
        q: "Hur lång är leveranstiden?",
        a: `De flesta beställningar levereras inom ${DELIVERY_ESTIMATE}. Beställningar lagda före kl. 14 på vardagar skickas normalt samma dag. Vid leverans av pallar eller tyngre gods kan det ta 2-5 arbetsdagar.`,
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Är du företagskund och vill beställa mot faktura eller större volym? Kontakta oss i chatten eller på info@batteriproffs.se så tar vi fram en offert och löser betalningen.",
      },
      {
    ...
    items: [
      {
        ...
        a: `Vi säljer till företag, och vid köp i näringsverksamhet finns ingen ångerrätt. Vi tar ändå emot returer i ${RETURN_WINDOW_DAYS} dagar. Mejla info@batteriproffs.se och invänta vårt godkännande innan du skickar tillbaka något, så får du returadress. Förpackningen ska vara obruten och batteriet får aldrig ha kopplats in eller laddats, inte ens för provkoppling. Vid godkänd retur av en felfri vara gör vi ett avdrag på ${RETURN_RESTOCKING_FEE_PERCENT} procent av varans värde, frakten återbetalas inte och du står för returfrakten.`,
      },
      {
        q: "Vad gäller om batteriet inte passar min maskin?",
        a: `Då gäller passformsgarantin, utan returavdrag. Har vi rekommenderat batteriet via batterifinnaren, telefon eller mejl byter vi till rätt modell och står för frakten åt båda hållen. Har du beställt på egen hand byter vi ändå utan avdrag, men då står du för returfrakten. Förpackningen måste vara obruten och batteriet får inte ha kopplats in. Hör av dig inom ${RETURN_WINDOW_DAYS} dagar och uppge maskinens märke och modell.`,
      },
      {
        q: "Kan jag ändra eller avbryta min order?",
        a: "Hör av dig så fort som möjligt i chatten eller på info@batteriproffs.se. Vi skickar i de flesta fall direkt från leverantör, och när ordern väl gått vidare dit kan vi inte längre stoppa den. Har batteriet redan skickats får du i stället hantera det som en retur, och då gäller villkoren ovan.",
      },
      {
        q: "Vad händer om jag inte hämtar ut paketet?",
        a: "Paketet skickas tillbaka till oss och du debiteras 349 kr för returfrakt och hantering. Batterierna väger mellan 19 och 63 kilo, så en outhämtad försändelse innebär frakt i båda riktningarna. Kan du inte ta emot leveransen, hör av dig i förväg så bokar vi om utan kostnad.",
      },
      {
        q: "Vad gör jag med mitt gamla batteri?",
        a: "Vi tar hand om det utan kostnad. Blybatterier är miljöfarligt avfall och får inte slängas som vanligt avfall, men de är också nästan helt återvinningsbara. Hör av dig i chatten eller på info@batteriproffs.se när du beställer, så bestämmer vi hur ditt gamla batteri hämtas eller lämnas.",
      },
      {

...
export const FAQ_SECTIONS = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Kassan på sajten är byggd för företag och kräver organisationsnummer, så en beställning går inte att slutföra som privatperson. Är du privatperson och vill köpa ett batteri, ring 076-686 77 52 eller mejla info@batteriproffs.se så löser vi det manuellt.",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Är du företagskund och vill beställa mot faktura eller större volym? Kontakta oss på info@batteriproffs.se eller 076-686 77 52 så tar vi fram en offert och löser betalningen.",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Hör av dig så fort som möjligt på 076-686 77 52. Vi skickar i de flesta fall direkt från leverantör, och när ordern väl gått vidare dit kan vi inte längre stoppa den. Har batteriet redan skickats får du i stället hantera det som en retur, och då gäller villkoren ovan.",
      },
      {
      ...
      },
      {
        ...
        a: "Vi tar hand om det utan kostnad. Blybatterier är miljöfarligt avfall och får inte slängas som vanligt avfall, men de är också nästan helt återvinningsbara. Hör av dig på 076-686 77 52 eller info@batteriproffs.se när du beställer, så bestämmer vi hur ditt gamla batteri hämtas eller lämnas.",
      },
      {

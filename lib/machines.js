 ...
 *   1. Tillverkarens reservdelslista för exakt modell/serienummer/utförande.
 *   2. Dokumenterade krav på spänning, kemi, mått, poler och laddning.
 * fitsTo-text eller enbart samma kapacitet är inte en verifierad passform.
 * Äldre kopplingar kvarstår som alternativ att kontrollera, inte verifierade ersättare.
 *
...
// 2026-09-05: SC250/SC401-kopplingarna motsägs av Nilfisks dokumentation.
// SC500 är också kopplad enbart genom samma obelagda fitsTo-text.
// Behåll hjälpsidorna, men inga produktrekommendationer innan leverantören verifierat dem.
// SC401: https://www.nilfisk.com/media/zhdba1pd/au-sc401-instructions-for-use.pdf
export const machines = [
{
    "slug": "tennant-t3-t3-plus",
    "name": "Tennant T3 / T3+",
    "brand": "Tennant",
    "group": "stadmaskiner",
    "type": "Skurmaskin, gelutförande",
    "products": [
        "gf-12-076v"
    ],
    "compatibilityVerified": true,
    "intro": "Tennants reservdelslista för T3/T3+ från serienummer 20000 anger två GF12076V i gelutförandet 12V/76Ah. Rekommendationen gäller just denna konfiguration. Kontrollera serienummer och befintligt batteriutförande före köp.",
    "description": "Dokumenterat batterival för Tennant T3/T3+, gelkonfiguration från serienummer 20000: två GF12076V. Originalkälla och kontrollpunkter.",
    "batteryEvidence": {
        "rows": [
            [
                "Gäller",
                "T3/T3+ från serienummer 20000, Battery Group Maintenance Free 12V/76Ah"
            ],
            [
                "Originalreferens",
                "Tennant 994200, batteribeteckning GF12076V, antal 2"
            ],
            [
                "Före montering",
                "Kontrollera att maskinen har gelutförandet, rätt anslutningskablar och laddarinställning. Andra batteripaket i samma maskinserie omfattas inte."
            ]
        ],
        "sources": [
            {
                "label": "Tennant reservdelsmanual 9007692, PDF-sida 85",
                "url": "https://www.tennantco.com/content/dam/tennant/tennantco/products/machines/scrubber%20walk-behinds/T3/operator-parts-manual/9007692.pdf#page=85"
            }
        ]
    }
},
  /* ───────── Städmaskiner ───────── */
  {
    ...
    products: [],
    intro: "Nilfisk SC250 använder ett modellspecifikt 36V litiumjonbatteri. Sortimentets lösa bly-, AGM- och gelbatterier är inte ersättare för detta batteripack.",
    description: "Hjälp att identifiera rätt batteri. Ingen verifierad produktkoppling publiceras innan variant och passform har kontrollerats.",
    verificationRequired: true,
    batteryEvidence: {
      "summary": "Nilfisk SC250 använder ett modellspecifikt 36V litiumjonbatteri. Sortimentets lösa bly-, AGM- och gelbatterier är inte ersättare för detta batteripack.",
      "rows": [
            [
                  "Batterisystem",
                  "36 V litiumjon, 1 batteripack"
            ],
            [
                  "Originalartikel",
                  "9100002056 eller 9100002070 enligt Nilfisks katalog. Kontrollera utförande och vad som ingår."
            ]
      ],
      "sources": [
            {
                  "label": "Nilfisk produktkatalog: batteritabell, tryckt sida 270",
                  "url": "https://www.nilfisk.com/media/vhllzu2q/nilfisk_produktkatalog_2024.pdf#page=270"
            }
      ]
},
  },
  {
    ...
    type: "Skurmaskin",
    products: [],
    intro: "SC401 med blybatterier har 24V-system och två 12V-batterier. Gel-, AGM- och våtbatteriutföranden förekommer. Kontrollera exakt maskinvariant; SC401 finns även med litiumbatteri.",
    description: "Hjälp att identifiera rätt batteri. Ingen verifierad produktkoppling publiceras innan variant och passform har kontrollerats.",
    verificationRequired: true,
    batteryEvidence: {
      "summary": "SC401 med blybatterier har 24V-system och två 12V-batterier. Gel-, AGM- och våtbatteriutföranden förekommer. Kontrollera exakt maskinvariant; SC401 finns även med litiumbatteri.",
      "rows": [
            [
                  "Batterifack",
                  "350 × 350 × 260 mm enligt SC401-manualen, engelsk sida 9"
            ],
            [
                  "Gelutförande",
                  "2 × 12 V 76 Ah. Nilfisk artikel 80564310"
            ],
            [
                  "Andra katalogutföranden",
                  "2 × 12 V 84 Ah AGM (1464853000) eller 2 × 12 V 85 Ah våtbatteri (80564800)"
            ],
            [
                  "Jämförelse med GF12076V",
                  "Två batterier upptar nominellt 330 × 342 × 236 mm och har rätt spänning och C5-kapacitet för gelutförandet. Poler, kablage, infästning och laddarprogram återstår att kontrollera. Detta är ingen färdig passformsrekommendation."
            ]
      ],
      "sources": [
            {
                  "label": "Nilfisk SC401: originalmanual, engelsk sida 9",
                  "url": "https://www.nilfisk.com/media/zhdba1pd/au-sc401-instructions-for-use.pdf#page=59"
            },
            {
                  "label": "Nilfisk produktkatalog: batteriutföranden",
                  "url": "https://www.nilfisk.com/media/vhllzu2q/nilfisk_produktkatalog_2024.pdf#page=270"
            },
            {
                  "label": "Exide GF-V: jämförelseunderlag",
                  "url": "https://www.exidegroup.com/eu/sites/default/files/2026-08/260806_e_sonnenschein_gf-v_datasheet_en_rz.pdf"
            }
      ]
},
  },
  {
    ...
    type: "Skurmaskin",
    products: [],
    intro: "SC500 finns med flera batteriutföranden. Nilfisks katalog listar olika par av 12V blybatterier för 24V-system, och separata litiumversioner finns också. Välj efter maskinens fullständiga variant.",
    description: "Hjälp att identifiera rätt batteri. Ingen verifierad produktkoppling publiceras innan variant och passform har kontrollerats.",
    verificationRequired: true,
    batteryEvidence: {
      "summary": "SC500 finns med flera batteriutföranden. Nilfisks katalog listar olika par av 12V blybatterier för 24V-system, och separata litiumversioner finns också. Välj efter maskinens fullständiga variant.",
      "rows": [
            [
                  "Batterifack",
                  "350 × 350 × 260 mm enligt Nilfisks SC500-broschyr"
            ],
            [
                  "Gelutföranden i katalogen",
                  "2 × 12 V 105 Ah (80564400) eller 2 × 12 V 76 Ah (80564310)"
            ],
            [
                  "Våtbatteriutföranden",
                  "2 × 12 V 110 Ah (80564600 eller L00200049), alternativt 2 × 12 V 85 Ah (80564800)"
            ],
            [
                  "Varför kapaciteten inte räcker som bevis",
                  "GF12105V är 283 mm högt enligt Exide, vilket överstiger fackets angivna höjd 260 mm. Därför rekommenderar vi inte batteriet enbart utifrån dess 105 Ah."
            ]
      ],
      "sources": [
            {
                  "label": "Nilfisk SC500: tekniska data och batterifackets mått",
                  "url": "https://www.nilfisk.com/media/cycmjwby/en-uk-sc500-li-on-brochure.pdf#page=4"
            },
            {
                  "label": "Nilfisk produktkatalog: batteriutföranden",
                  "url": "https://www.nilfisk.com/media/vhllzu2q/nilfisk_produktkatalog_2024.pdf#page=270"
  ...
  },
  {
    ...
    intro:
      "Tennants åkbara maskiner används i industri, logistik och offentliga miljöer. Vilket batteri som passar avgörs av modellens systemspänning och batterifackets mått — chatta med oss och ange modellnumret så tar vi fram rätt paket.",
  },
  {

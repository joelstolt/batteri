...
export async function skickaOmdomeNotis({ betyg, text, namn, slug, orderId, epost }) {
  ...
  const body = `
    ...
    <p style="margin:0 0 8px;text-align:center;">
      <a href="${SITE_URL}/admin" class="bp-knapp" style="display:inline-block;background:#0B1D3A;color:#fff;text-decoration:none;padding:14px 28px;border-radius:10px;font-weight:700;font-size:14px;">

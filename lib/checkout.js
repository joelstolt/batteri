...
export function validateCheckout(form = {}) {
  ...
  // Er referens gjordes valfri 2026-09-01: ett obligatoriskt fält över
  // Baymard-standard, och avhoppsdatan visade att kassan ska bantas, inte
  // byggas ut. Fylls den i trycks den på fakturan som förut.
  if (get("reference").length > 80) e.reference = "Max 80 tecken"

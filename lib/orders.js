...
export function normaliseraOrder(pi) {
  ...
  return {
    ...
    // Kunden ser bara två lägen. "Betald" betyder att pengarna gått igenom,
    // "skickad" att vi matat in ett spårningsnummer.
    status: meta.shipped_at ? "skickad" : "betald",
    items: parsaItems(meta.items),
